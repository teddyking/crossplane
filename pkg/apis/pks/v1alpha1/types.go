...
type ProviderSpec struct {
	...
	// PKS ServiceAccount json secret key reference
	Secret corev1.SecretKeySelector `json:"credentialsSecretRef"`

	// PKS ProjectID (name)
	ProjectID string `json:"projectID"`

	// RequiredPermissions  - list of granted PKS permissions this provider's service account is expected to have
	RequiredPermissions []string `json:"requiredPermissions,omitempty"`
}

// ProviderStatus represents the status of a PKS Provider.
